...
using RecipeOrganizer.Areas.Identity.Models.RoleViewModels;
using RecipeOrganizer.Areas.Identity.Models.UserViewModels;
...
using RecipeOrganizer.Areas.Identity.Controllers;
...
namespace RecipeOrganizer.Areas.Identity.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, Recipe_OrganizerContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
