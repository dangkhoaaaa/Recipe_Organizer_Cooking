...
namespace RecipeOrganizer.Areas.Identity.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, Recipe_OrganizerContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
