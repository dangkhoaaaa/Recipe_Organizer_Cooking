...
namespace RecipeOrganizer.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required(ErrorMessage = "Field can not empty")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _signInManager.PasswordSignInAsync(Input.UserNameOrEmail, Input.Password, Input.RememberMe, lockoutOnFailure: false);//thiết thập true thì đăng nhập sai thì sẽ khóa

                //tìm username đăng nhập lại
                if (!result.Succeeded)
                {
                ...
                {
                    _logger.LogWarning("Account was banned.");
